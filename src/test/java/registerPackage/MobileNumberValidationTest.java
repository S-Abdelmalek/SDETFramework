...
public class MobileNumberValidationTest extends Base {
	...
	void validateMobileNumberNegative (String fname,String lname,String mob,String email,String pass,String passconf) throws IOException, Exception
	{
	...
	Object[][] getData () throws IOException
	{
		...
		for (int i=0 ; i<4 ; i++)
		{
			testData = data.getDataFromExcelSheet("validateMobileNumberNegative"+String.valueOf(i+1));
			for (int j=0  ; j<6 ;j++)
			{
